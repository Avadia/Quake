...
public abstract class Arena extends Game<APlayer> {
    ...
    protected void loadConfig() {
        ...
        goal = properties.getGameOption("Goal", new JsonPrimitive(25)).getAsInt();

        warningJoinMessage = properties.getGameOption("WarningJoinMessage", new JsonPrimitive("")).getAsString();
        ...
        JsonArray potions = properties.getGameOption("Potions", potionsDefault).getAsJsonArray();
    ...
    public void handleLogin(Player p) {
        ...
        this.coherenceMachine.getMessageManager().writePlayerJoinToAll(p, true);
        execJoinPlayer(ap);
    ...
    public void sendBarTo(Player p, String message) {
        ActionBarAPI.sendMessage(p, message);
    }
